...
export const CLOTH_CONFIG = {
    ...
    groomsUmukenyero: { label: "Umukenyero(umukwe)", hasColor: true, hasSize: false, hasType: null },
    boysUmukenyero: { label: "Umukenyero(abasore)", hasColor: true, hasSize: false, hasType: null },
